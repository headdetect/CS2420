...
/**
 * Objects of this class represent a single Huffman token. A Huffman token is just a data value (a byte), a frequency, and the Huffman code for this token.
 * 
...
public class HuffmanToken
{
	...
	/**
	 * This constructor initializes the token to its default values. A byte value is stored in the token, the frequency is set to zero, and an empty code is created.
	 * <p>
	 * &nbsp;
	 * <p>
	 * 
	 * The frequency and code will be set up later as the Huffman compression (or decompression) proceeds.
	 * 
	 * @param value
	...
	/**
	 * Adds the specified bit to the beginning of the Huffman code for this token.
	 * 
	 * @param bit
	...
	/**
	 * Returns a copy of the Huffman code that represents this token. The first bit of the Huffman code is in the 0th position in the ArrayList.
	 * 
